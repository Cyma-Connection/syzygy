...
const STR = {
  ...
  fr: {
    ...
    startTitle: 'ORBIT SNAP',
    startBody: 'Ton craft orbite. <b style="color:var(--amber)">Sens</b> l’alignement soleil→objet, puis <b style="color:var(--amber)">SNAP</b>. Débris = danger. 3 "Perfect" débloquent <b style="color:var(--cold)">LOCK</b>. Pinch = zoom.',
    play: 'JOUER',
    ...
    coach3t: 'SNAP',
    coach3b: 'SNAP au sweet spot. Débris = danger. 3 "Perfect" → LOCK.',
