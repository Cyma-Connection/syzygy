...
const STR = {
  en: {
    ...
    startBody: 'Your craft orbits alone. <b style="color:var(--amber)">Feel</b> sun→object alignment, then <b style="color:var(--amber)">SNAP</b>. Debris = danger. 5 "Perfect" charge <b style="color:var(--cold)">LOCK</b> (short reverse). Pinch = zoom.',
    play: 'PLAY',
    ...
    coach4t: 'LOCK',
    coach4b: '5 "Perfect" in a row charge LOCK. Tap once for a short reverse on your orbit — one charge only.',
  ...
  fr: {
    ...
    coach4t: 'LOCK',
    coach4b: '5 "Perfect" d’affilée chargent LOCK. Un appui = marche arrière courte sur l’orbite — une seule charge.',
  ...
  es: {
    ...
    startTitle: 'ORBIT SNAP',
    startBody: 'Tu nave orbita sola. <b style="color:var(--amber)">Siente</b> la alineación sol→objeto, luego <b style="color:var(--amber)">SNAP</b>. Escombros = peligro. 5 "Perfect" cargan <b style="color:var(--cold)">LOCK</b> (marcha atrás corta). Pellizca = zoom.',
    play: 'JUGAR',
    ...
    coach4t: 'LOCK',
    coach4b: '5 "Perfect" seguidos cargan LOCK. Un toque = marcha atrás corta en la órbita — una sola carga.',
