...
const STR = {
  en: {
    ...
    startBody: 'Your craft orbits alone. <b style="color:var(--amber)">Feel</b> sun→object alignment, then <b style="color:var(--amber)">SNAP</b>. Debris = danger. 3 "Perfect" charge <b style="color:var(--cold)">LOCK</b>. 7 relic SNAPs open a <b style="color:var(--amber)">portal</b> bonus. Pinch = zoom.',
    play: 'PLAY',
    ...
    coach4t: 'LOCK',
    coach4b: '3 "Perfect" in a row charge LOCK. Tap once (desktop: Space) for a short reverse — one charge only.',
    ...
    hintBonus: 'BONUS · SNAP the bright orbs',
    bonusTimer: (s) => `BONUS ${s}s`,
    bonusEnter: 'BONUS STAGE',
  ...
  fr: {
    ...
    startTitle: 'ORBIT SNAP',
    startBody: 'Votre vaisseau orbite seul. <b style="color:var(--amber)">Sentez</b> l’alignement Soleil–Objet puis <b style="color:var(--amber)">SNAP</b>. Débris = danger. 3 "perfect" → <b style="color:var(--cold)">LOCK</b>. 7 SNAPs relic → <b style="color:var(--amber)">portail</b> bonus. Pinch = zoom.',
    play: 'JOUER',
    ...
    coach4t: 'LOCK',
    coach4b: '3 "Perfect" d’affilée chargent LOCK. Un appui (ordi : Espace) = marche arrière courte — une seule charge.',
    ...
    hintBonus: 'BONUS · SNAP les orbes brillantes',
    bonusTimer: (s) => `BONUS ${s}s`,
    bonusEnter: 'STAGE BONUS',
  ...
  es: {
    ...
    startTitle: 'ORBIT SNAP',
    startBody: 'Tu nave orbita sola. <b style="color:var(--amber)">Siente</b> la alineación sol→objeto, luego <b style="color:var(--amber)">SNAP</b>. Escombros = peligro. 3 "Perfect" → <b style="color:var(--cold)">LOCK</b>. 7 SNAPs relic → <b style="color:var(--amber)">portal</b> bonus. Pellizca = zoom.',
    play: 'JUGAR',
    ...
    coach4t: 'LOCK',
    coach4b: '3 "Perfect" seguidos cargan LOCK. Un toque (PC: Espacio) = marcha atrás corta — una sola carga.',
    ...
    hintBonus: 'BONUS · SNAP las orbes brillantes',
    bonusTimer: (s) => `BONUS ${s}s`,
    bonusEnter: 'FASE BONUS',
